...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<a href="http://www.telekom.si/" class="canvasclass" target="_blank">
		...
		<section class="grid">
			...
			<footer>
                ...
                <input type="button" class="footp3" value="Pokaži na mapi" id="showloc"/>
                <div class="footp3" id="locdiv"></div>
				<p class="footp3"><span id="vpisnap">Vpisna &#353;tevilka</span>: 63110185</p>
				<p class="footp4">Veti.si - 2014</p>
			</footer>
		</section>
	</body>
</html>
